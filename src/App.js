    ...
    <Router>   
      <Routes>
        <Route path='/' element= {<LandingPage/>}></Route>
          <Route path='/dash' element={<Home access_token={access_token} user_id={user_id} setPlan_id={setPlan_id} setPrice={setPrice} />}></Route> 
          <Route path='/payment' element={<Payment plan_id={plan_id} price={price} />}></Route>
